...
function sendResetPasswordEmail($to, $token, $username, $requestOrigin = null) {
    $frontendUrl = null;
    ...
    $resetLink = "$frontendUrl/auth/reset_password.html?token=" . urlencode($token);
    $subject = 'Camagru – Password Reset Request';
    $htmlBody = "
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body>
                ...
                <div class='email-container'>
                    ...
                    <div class='email-content'>
                        ...
                        <p class='expiry-info'>This link will expire in 10 minutes.</p>
                    </div>
