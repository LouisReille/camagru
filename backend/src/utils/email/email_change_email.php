...
function sendEmailChangeVerificationEmail($to, $token, $requestOrigin = null) {
    ...
    $verificationLink = "$backendUrl/src/api/users/verify_email_change.php?token=$token";
    ...
    $htmlBody = "
            ...
            <body>
                ...
                <div class='email-container'>
                    ...
                    <div class='email-content'>
                        ...
                        <p class='expiry-info'>This link will expire in 1 hour.</p>
                    </div>
                    <div class='email-footer'>
                        <p>If you didn't request this email change, please ignore this email. Your email address will remain unchanged.</p>
                    </div>
                </div>
                </div>
            </body>
        ...
        ";
    $textBody = "Verify your new email address\n\nYou requested to change your email address. Visit this link to verify:\n$verificationLink\n\nThis link expires in 1 hour.\n\nIf you didn't request this email change, please ignore this email.";
